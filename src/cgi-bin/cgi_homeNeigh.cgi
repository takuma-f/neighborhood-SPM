...
<html lang="ja">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href=""><i class="glyphicon glyphicon-heart"></i> 推薦を受ける (2)</a></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </div>
  ...
  print """
          ...
          <div class="panel-footer">
            <button type="button" class="btn btn-primary" id="submitContext" value="neigh" style="width:150px;">プランを作る</button>
