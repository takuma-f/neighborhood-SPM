$('#saveRating').click(function() {
  ...
  var param66 = $('#focus1').val() || "None";
  var param67 = $('#focus2').val() || "None";
  if ((param46 != "None") && (param47 != "None") && (param48 != "None") && (param49 != "None") && (param50 != "None") && (param51 != "None") && (param52 != "None") && (param53 != "None") && (param54 != "None") && (param55 != "None")) {
    $.ajax({
      ...
      data: {userId:param1, date:param2, companion:param3, budget:param4, seed:param5, 
        ...
        intpattern7:param62, intpattern8:param63, intpattern9:param64, intpattern10:param65, focus1:param66, focus2:param67},
        // 最後のカンマ忘れやすいので注意すること
      dataType: 'HTML',
      timeout: 100000,
      success: function(res) {
        $('#response').html('<span id="alert">評価を保存しました, 次の実験を行ってください. </span>');
      },
